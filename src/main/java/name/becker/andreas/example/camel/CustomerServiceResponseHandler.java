...
/**
 * Interface for handling response of the customer REST service.
 */
public interface CustomerServiceResponseHandler {

	/**
	 * Handles the 201 / created response of a successful PUT request to the
	 * customer example REST service.
	 * 
	 * @param locationHeader
	 *            Location header returned by the service
	 */
